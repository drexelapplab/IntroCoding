...
/*: 
 # Welcome 
 This is an Introduction to Coding for Beginners.
...
/*: 
 ## Comments
 You can also add code that the computer will not run. This is called a comment. Here are a few examples of comments.
 */
